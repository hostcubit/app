          ...
          <div class="col-xxl-5 col-xl-6">
            ...
            <div class="banner-content">
              <h1 class="banner-title text-gradient">{{getTranslatedArrayValue(@$banner_content->section_value, 'heading') }}<span class="banner-title-shape">
                  <span>
                    <img src="{{asset('assets/file/images/frontend/static/long-arrow.svg')}}" alt="long-arrow"/>
                  </span>
                  <span>
                    <img src="{{asset('assets/file/images/frontend/static/globe.svg')}}" alt="long-arrow"/>
                  </span>
                </span>
              </h1>
