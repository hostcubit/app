...
<main class="main-body">
  <div class="container-fluid px-0 main-content">
    ...
    <div class="card">
      <div class="card-body">
        <form action="{{route('admin.membership.plan.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row gy-4 gx-xl-5">
                  <div class="col-md-6">
                    <div class="form-inner">
                      ...
                      <input type="text" id="name" class="form-control" placeholder="{{ translate("Enter membership plan name") }}" name="name" aria-label="name" value="{{ $plan->name }}"/>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-inner">
                      ...
                      <div class="input-group">
                        <input type="number" name="duration" id="duration" class="form-control" placeholder="{{ translate("Enter membership plan duration") }}" value="{{ $plan->duration }}"/>
                  ...
                  <div class="col-12">
                    <div class="form-inner">
                      ...
                      <textarea type="text" name="description" id="description" class="form-control" placeholder="{{ translate("Write description for the membership plan") }}" aria-label="description">{{ $plan->description }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-inner">
                      ...
                      <div class="input-group">
                        <input type="text" id="amount" step="0.01" class="form-control" placeholder="{{ translate("Enter membership plan price") }}" aria-label="amount" name="amount" value="{{ $plan->amount }}"/>
                    ...
                    <div class="form-inner">
                      ...
                      <div class="form-inner-switch">
                        ...
                        <div class="switch-wrapper mb-1">
                          <input type="checkbox" class="switch-input" id="allow_carry_forward" name="allow_carry_forward" value="true" {{ $plan->carry_forward == \App\Enums\StatusEnum::TRUE->status() ? "checked" : ""}}/>
                    ...
                    <div class="col-12">
                        <div class="form-inner">
                          <div class="form-inner-switch">
                            ...
                            <div class="switch-wrapper mb-1">
                              <input type="checkbox" class="switch-input" {{ $plan->type == \App\Enums\StatusEnum::TRUE->status() ? "checked" : "" }} id="allow_admin_creds" name="allow_admin_creds" value="{{ $plan->type == \App\Enums\StatusEnum::FALSE->status() ? "true" : "false" }}"/>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="row gy-4 gx-xl-5">
                                ...
                                <div class="form-inner-switch">
                                    ...
                                    <div class="switch-wrapper mb-1">
                                    <input class="switch-input allow_admin_sms" type="checkbox" value="true" name="allow_admin_sms" id="allow_admin_sms" {{$plan->sms->is_allowed == true ? "checked" : ""}}>
                                ...
                                <div class="form-inner-switch">
                                    ...
                                    <div class="switch-wrapper mb-1">
                                    <input class="switch-input allow_admin_sms" type="checkbox" value="true" name="allow_admin_android" id="allow_admin_android" {{ $plan->sms->android->is_allowed == true ? "checked" : "" }}>
                                ...
                                <div class="col-md-6 admin-sms-credit">
                                  <div class="form-inner">
                                      ...
                                      <div class="input-group">
                                      <input type="number" min="-1" class="form-control" id="sms_credit_admin" name="sms_credit_admin" placeholder="{{ translate('Enter SMS Credit')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{ $plan->sms->credits }}">
                                ...
                                <div class="col-md-6 admin-sms-per-day-credit">
                                  <div class="form-inner">
                                      ...
                                      <div class="input-group">
                                        <input type="number" min="0" class="form-control" id="sms_credit_per_day_admin" name="sms_credit_per_day_admin" placeholder="{{ translate('Enter SMS Credit')}}" aria-label="SMS Credits per day" aria-describedby="basic-addon2" value="{{ $plan->sms->credits_per_day ?? '0' }}">
                            ...
                            <div class="row gy-4 gx-xl-5">
                                ...
                                <div class="form-inner-switch">
                                    ...
                                    <label for="allow_admin_whatsapp">
                                        <p class="fs-16 mb-3"> {{ translate("Allow users to add Whatsapp Devices") }} </p>
                                        <span>{{ translate("Enable unlimited Devices if you set 'Whatsapp Device Limit' value to '0'") }}</span>
                                    </label>
                                ...
                                <div class="col-md-12 d-none">
                                  <div class="form-inner">
                                      ...
                                      <div class="input-group">
                                      <input type="number" class="form-control" id="whatsapp_device_limit" name="whatsapp_device_limit" placeholder="{{ translate('Users can Add upto')}}" aria-label="Whatsapp Device Limit" aria-describedby="basic-addon2" value="{{ $plan->whatsapp->gateway_limit ?? "0" }}">
                            ...
                            <div class="row gy-4 gx-xl-5">
                                ...
                                <div class="form-inner-switch">
                                  <div>
                                    <label for="allow_user_android">
                                        ...
                                        <span>{{ translate("Enable unlimited Android Gateways if you set the value to '0'") }}</span>
                                    </label>
                                    
                                  </div>
                                 
                                  <div class="switch-wrapper mb-1">
                                    <input class="switch-input allow_user_sms" type="checkbox" value="true" name="allow_user_android" id="allow_user_android" {{ $plan->sms->android->is_allowed == true ? "checked" : "" }}>
                              ...
                              <div class="col-md-6">
                                <div class="form-inner-switch">
                                  ...
                                  <div class="switch-wrapper mb-1">
                                    <input class="switch-input allow_user_sms sms_gateway" type="checkbox" value="true" name="sms_multi_gateway" id="sms_gateway" {{ $plan->sms->is_allowed == true ? 'checked' : ' ' }}>
                              ...
                              <div class="col-md-6 user-sms-credit {{ $plan->sms->is_allowed == false ? "d-none" : "" }}">
                                <div class="form-inner">
                                  <label for="sms_credit_user" class="form-label"> {{ translate("SMS credit limit") }} </label>
                                  <div class="input-group">
                                    <input value="{{ $plan->sms->credits }}" min="-1" type="number" class="form-control" id="sms_credit_user" name="sms_credit_user" placeholder="{{ translate('Enter SMS Credit')}}" >
                                    <span class="input-group-text fs-14" id="sms_credit_user"> {{ translate("Credit limit") }} </span>
                                  </div>
                                  <p class="form-element-note">{{ translate("Set this value to -1 to allow unlimited credit spending.") }}</p>
                                </div>
                              </div>
                              <div class="col-md-6 user-sms-per-day-credit {{ $plan->sms->is_allowed == false ? "d-none" : "" }}">
                                <div class="form-inner">
                                    <label for="sms_credit_per_day_user" class="form-label"> {{ translate("SMS per day credit limit") }} </label>
                                    <div class="input-group">
                                    <input type="number" min="0" value="{{ $plan->sms->credits_per_day ?? '0' }}" class="form-control" id="sms_credit_per_day_user" name="sms_credit_per_day_user" placeholder="{{ translate('Enter SMS Credit')}}" aria-label="SMS Credits per day" aria-describedby="basic-addon2" >
                        ...
                        <div class="row gy-4">
                          ...
                          <div class="col-xxl-8 col-xl-9">
                            <div class="row gy-4 gx-xl-5">
                                ...
                                <div class="form-inner-switch">
                                  <div>
                                    <label for="allow_user_whatsapp">
                                        <p class="fs-16 mb-3"> {{ translate("Allow users to add Whatsapp Devices") }} </p>
                                        <span>{{ translate("Enable unlimited Devices if you set the value to '0'") }}</span>
                                    </label>
                                  </div>
                                  <div class="switch-wrapper mb-1">
                                    <input type="checkbox" class="switch-input" id="switch-3" />
                              ...
                              <div class="col-md-6 user-whatsapp-credit {{ $plan->whatsapp->is_allowed == false ? "d-none" : "" }}">
                                <div class="form-inner">
                              ...
                              <div class="col-md-6 user-whatsapp-per-day-credit {{ $plan->whatsapp->is_allowed == false ? "d-none" : "" }}">
                                <div class="form-inner">
                          ...
                          <div class="col-xxl-8 col-xl-9">
                            <div class="row gy-4 gx-xl-5">
                              ...
                              <div class="col-md-6 user-email-credit {{ $plan->email->is_allowed == false ? "d-none" : "" }}">
                                <div class="form-inner">
                                  <label for="gatewayLimit" class="form-label"> {{ translate('Email Credit Limit')}} </label>
                                  <div class="input-group">
