							...
							<div class="row g-4">
							  <div class="col-md-12">
								<div class="form-inner">
								  ...
								  <input type="password" id="current_password" class="form-control" name="current_password" placeholder="******" aria-label="current_password" />
								</div>
							  </div>
							  <div class="col-md-6">
								<div class="form-inner">
								  <label for="new_password" class="form-label">{{ translate("New Password") }}</label>
								  <input type="password" id="new_password" class="form-control" name="password" placeholder="******" aria-label="new_password" />
								</div>
							  </div>
							  <div class="col-md-6">
								<div class="form-inner">
								  <label for="password_confirmation" class="form-label">{{ translate("Confirm password ") }}</label>
								  <input type="password" id="password_confirmation" class="form-control" name="password_confirmation" placeholder="******" aria-label="password_confirmation" />
								</div>
							  </div>
							</div>
						  </div>
