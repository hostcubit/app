        ...
        <div class="card-header">
            ...
            <div class="card-header-right">
                <div class="d-flex gap-3 align-item-center">
                    ...
                    <a class="i-btn btn--primary btn--sm" href="{{ route("admin.contact.create") }}">
                    ...
                    <tr>
                        ...
                        <td data-label="{{ translate('Status')}}">
                            <div class="switch-wrapper checkbox-data">
                                <input {{ $contact->status == \App\Enums\StatusEnum::TRUE->status() ? 'checked' : '' }}
                                        type="checkbox"
                                        class="switch-input statusUpdate"
                                        data-id="{{ $contact->id }}"
                                        data-column="status"
                                        data-value="{{ $contact->status }}"
