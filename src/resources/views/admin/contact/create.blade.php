    ...
    <div class="container-fluid px-0 main-content">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <form id="contact_store" action="{{route('admin.contact.save')}}" method="POST">
                    @csrf
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-inner">
                                                ...
                                                <input type="number" id="sms_contact" name="sms_contact" class="form-control" placeholder="Enter number" aria-label="Enter sms contact number" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-inner">
                                                <label for="email_contact" class="form-label"> {{ translate("Email Address") }} </label>
                                                <input type="email" id="email_contact" name="email_contact" class="form-control" placeholder="Enter email" aria-label="Enter email address" />
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="{{ $loop->last && $loop->odd ? 'col-md-12' : 'col-md-6' }}">
                                                        ...
                                                        @if($attribute_value->type == \App\Models\GeneralSetting::DATE)
                                                            <input type="date" value="{{ old($attribute_key) }}" class="form-control mb-3 flatpicker" id="{{ $attribute_key }}" name="meta_data[{{ $attribute_key."::".$attribute_value->type }}]" placeholder=" {{ translate('Choose Contact ').textFormat(["_"], $attribute_key)}}">
                                                        @elseif($attribute_value->type == \App\Models\GeneralSetting::BOOLEAN)
                                                            <select class="form-select mb-3" name="meta_data[{{ $attribute_key."::".$attribute_value->type }}]" id="{{ $attribute_key }}" required>
                                                        ...
                                                        @elseif($attribute_value->type == \App\Models\GeneralSetting::NUMBER)
                                                            <input type="number" value="{{ old($attribute_key) }}" class="form-control mb-3" id="{{ $attribute_key }}" name="meta_data[{{ $attribute_key."::".$attribute_value->type }}]" placeholder=" {{ translate('Enter Contact ').textFormat(["_"], $attribute_key)}}">
                                                        @else
                                                            <input type="text" value="{{ old($attribute_key) }}" class="form-control mb-3" id="{{ $attribute_key }}" name="meta_data[{{ $attribute_key."::".$attribute_value->type }}]" placeholder=" {{ translate('Enter Contact ').textFormat(["_"], $attribute_key)}}">
                                                        @endif
                                                    </div>
                        ...
                        <div class="row g-3 my-3 columnData">
                            ...
                            <div class="col-lg-6 col-sm-8 value">
                                <select class="form-select select-attribute" name="header_value[]" aria-label="Large select example">
                                    ...
                                    @forelse($filtered_meta_data as $attributeName => $attribute)
