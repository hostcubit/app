    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-right">
                ...
                <a class="i-btn btn--info btn--sm me-2" href="{{ route("admin.system.setting", ["type" => "webhook"]) }}">
                            ...
                            @forelse ($gateways as $item)
                                ...
                                <tr>
                                    ...
                                    <td data-label="{{ translate('Templates')}}">
                                        <a href="{{route('admin.template.whatsapp.index', ['id' => $item->id])}}" class="badge badge--primary p-2">
