...
class CustomerService
{
    ...
    public function canSpendCredits($user, $allowed_access, $type) {
        ...
        $pass = false;
        $allowed_per_day = array_key_exists('credits_per_day', $allowed_access->{strtolower(ServiceType::getValue($type))}) ? $allowed_access->{strtolower(ServiceType::getValue($type))}['credits_per_day'] : 0;
