...
class AndroidApiController extends Controller
{
    ...
    public function statusUpdate(Request $request) {
        ...
        try {
            ...
            if($android_api->status == StatusEnum::TRUE->status() || ($android_access->is_allowed && ($android_device_count < $android_access->gateway_limit || $android_access->gateway_limit == 0))) { 
